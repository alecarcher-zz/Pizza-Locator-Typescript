...
import { Accordion, AccordionItem, ProgressIndicator, ProgressBar } from 'luna-react'
...
class Result extends Component<TheseProps> {
    ...
    private displayOpeningTimes() {
        ...
        const list = 
            this.props.openingHours.map((openingSlot: OpeningTime) =>
